...
class ProductReviewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_review" do
    assert_difference('ProductReview.count') do
      post product_reviews_url, params: { product_review: { name: @product_review.name, product_id: @product_review.product_id, rating: @product_review.rating, review_text: @product_review.review_text } }
    end
  ...
  test "should update product_review" do
    patch product_review_url(@product_review), params: { product_review: { name: @product_review.name, product_id: @product_review.product_id, rating: @product_review.rating, review_text: @product_review.review_text } }
